...
data_file = 'M83-14_HI_1215_vel_mask.reg'
lsf_file = 'M83_14_COS_LSF_TOTAL_G130M_1291_LP3.dat'
...
dataset.add_component_velocity('HI', 527.0, 0.5, 20., var_z=False, var_b=False)
...
dataset.save_fit_regions(filename='M83-14_total')
VoigtFit.io.output.save_individual_components(dataset, "M83-14_components.dat")